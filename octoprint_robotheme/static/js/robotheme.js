$(function() {
  function robothemeViewModel(parameters) {
    ...
    self.onAllBound = function() {
      ...
      var element, equipmentName, elementSidebar, elementActual, elementTarget;
